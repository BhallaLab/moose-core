...
# in user space and in the kernel space), and plots it against the size of the
# cell. Suitable for the rallpack1 and rallpack2 benchmarks.
...
size <- Size[ Script == script & Command == "../../moose" & SimLength < 0.25 ]
