...
p \
	...
	'copasi.plot' every :::0::0 title 'TOR_minus_clx(copasi)' 
...
p \
	...
	'copasi.plot' every :::1::1 title 'S6K_star_(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::2::2 title 'S6K(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
	set output 'S6K.png'
	replot
...
p \
	...
	'copasi.plot' every :::3::3 title 'S6K_thr_minus_412(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::4::4 title '_40S_inact_(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::5::5 title 'PDK1(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
	set output 'PDK1.png'
	replot
...
p \
	...
	'copasi.plot' every :::6::6 title 'PP2A(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
	set output 'PP2A.png'
	replot
...
p \
	...
	'copasi.plot' every :::7::7 title 'Rheb_minus_GTP(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::8::8 title 'TOR_Rheb_minus_GTP_clx(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::9::9 title 'S6K_tot(copasi)'
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::10::10 title '_40S(copasi)'
	pause mouse key "Any key to continue.\n"
	set term png
	set output '_40S.png'
	replot
...
p \
	...
	'copasi.plot' every :::11::11 title 'S6K_thr_minus_252(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::12::12 title 'MAPK_star(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::13::13 title '_40S_basal(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
