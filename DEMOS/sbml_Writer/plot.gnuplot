...
p \
	...
	'copasi.plot' every :::0::0 title 'copasi' 
...
p \
	...
	'copasi.plot' every :::1::1 title 'copasi' 
	pause mouse key "Any key to continue.\n"
	set term png
	set output 'PP2A.png'
	replot
...
p \
	...
	'copasi.plot' every :::2::2 title 'copasi' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::3::3 title 'copasi' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::4::4 title 'copasi' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::5::5 title 'S6K_star_(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::6::6 title 'S6K(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
	set output 'S6K.png'
	replot
...
p \
	...
	'copasi.plot' every :::7::7 title 'S6K_thr_minus_412(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
...
p \
	...
	'copasi.plot' every :::8::8 title '40S_inact(copasi)' 
	pause mouse key "Any key to continue.\n"
	set term png
