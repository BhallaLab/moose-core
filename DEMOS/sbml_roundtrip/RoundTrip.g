...
str infile1 = "acc88.xml" // file to read
str outfile1 = "moose1.plot" //simulation result
str infile2 = "acc88_dup.xml" //file to write
str outfile2 = "moose2.plot" //simulation result 
int plot_all = 1
...
readSBML { infile1 } { target }  //read the file into moose
writeSBML { infile2 } { target } //write the file 
