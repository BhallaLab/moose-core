...
function make_Moczyd_KC
	...
	*/
		...
		call Moczyd_KC/xGate/A load XA.txt 0
		call Moczyd_KC/xGate/B load XB.txt 0
		
	/*
		setfield Moczyd_KC X_A->calc_mode {LIN_INTERP}
		setfield Moczyd_KC X_B->calc_mode {LIN_INTERP}
	*/
		setfield Moczyd_KC X_A->calc_mode 1
		setfield Moczyd_KC X_B->calc_mode 1
