// genesis 2.2 - "Stand-alone" version of the mitral cell model based
// on the traub91 tutorial with
...
setclock  1  1e-4               // set the simulation clock
...
// include bulbchan.g
// We use moosebulbchan.g just to show it is completely vanilla
// genesis script code, and to confirm that it matches. Also 
// moosebulbchan.g models are hsolvable.
