...
class SquidSetup(object):
    ...
    def setup_recording(self):
        ...
        moose.connect(self.cmd_table, 'requestOut', self.clamp_ckt.vclamp, 'getOutput')
        self.iclamp_table = moose.Table('/data/Iclamp')
        moose.connect(self.iclamp_table, 'requestOut', self.clamp_ckt.iclamp, 'getOutput')
        self.vclamp_table = moose.Table('/data/Vclamp')
        moose.connect(self.vclamp_table, 'requestOut', self.clamp_ckt.pid, 'getOutput')
