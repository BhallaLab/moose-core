...
/* Can run in MOOSE and GENESIS. Need to flip the MOOSE flag below, though.
 * The model: 2 linear cells, with a synapse. 1st cell is excitable, 2nd is not.
 * Uses readcell, and the hsolve method.
 */
