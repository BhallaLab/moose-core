...
double HHChannel2D::getXpower( const Eref& e, const Qinfo* q ) const
{
	return Xpower_;
}

double HHChannel2D::getYpower( const Eref& e, const Qinfo* q ) const
{
	return Ypower_;
}

double HHChannel2D::getZpower( const Eref& e, const Qinfo* q ) const
{
	return Zpower_;
}
...
void HHChannel2D::createGate( const Eref& e, const Qinfo* q, 
	string gateType )
{
