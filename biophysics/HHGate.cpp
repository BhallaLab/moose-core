...
vector< double > HHGate::getAlpha( const Eref& e, const Qinfo* q ) const 
{
	return alpha_;
}

void HHGate::setAlpha( const Eref& e, const Qinfo* q, vector< double > val )
{
	if ( val.size() != 5 ) {
...
vector< double > HHGate::getBeta( const Eref& e, const Qinfo* q ) const 
{
	return beta_;
}

void HHGate::setBeta( const Eref& e, const Qinfo* q, vector< double > val )
{
	if ( val.size() != 5 ) {
...
vector< double > HHGate::getTau( const Eref& e, const Qinfo* q ) const 
{
	return tau_;
}

void HHGate::setTau( const Eref& e, const Qinfo* q, vector< double > val )
{
	if ( val.size() != 5 ) {
...
vector< double > HHGate::getMinfinity( const Eref& e, const Qinfo* q ) const 
{
	return mInfinity_;
}

void HHGate::setMinfinity( const Eref& e, const Qinfo* q, vector< double > val )
{
	if ( val.size() != 5 ) {
...
double HHGate::getMin( const Eref& e, const Qinfo* q ) const 
{
	return xmin_;
}
...
double HHGate::getMax( const Eref& e, const Qinfo* q ) const 
{
	return xmax_;
}
...
unsigned int HHGate::getDivs( const Eref& e, const Qinfo* q ) const 
{
	return A_.size() - 1;
}

void HHGate::setDivs( const Eref& e, const Qinfo* q, unsigned int val )
{
...
// static func
void HHGate::setupAlpha( const Eref& e, const Qinfo* q, 
	vector< double > parms )
{
...
// static func
void HHGate::setupTau( const Eref& e, const Qinfo* q,
	vector< double > parms )
{
...
void HHGate::setupGate( const Eref& e, const Qinfo* q, 
	vector< double > parms )
{
