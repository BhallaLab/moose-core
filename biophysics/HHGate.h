...
class HHGate
{
	...
	public:
		...
		// Field functions
		//////////////////////////////////////////////////////////
		void setAlpha( const Eref& e, const Qinfo* q, vector< double > val);
		vector< double > getAlpha( const Eref& e, const Qinfo* q ) const;
		void setBeta( const Eref& e, const Qinfo* q, vector< double > val );
		vector< double > getBeta( const Eref& e, const Qinfo* q ) const;
		void setTau( const Eref& e, const Qinfo* q, vector< double > val );
		vector< double > getTau( const Eref& e, const Qinfo* q ) const;
		void setMinfinity( const Eref& e, const Qinfo* q, 	
			vector< double > val );
		vector< double > getMinfinity( const Eref& e, const Qinfo* q) const;

		void setMin( const Eref& e, const Qinfo* q, double val );
		double getMin( const Eref& e, const Qinfo* q ) const;
		void setMax( const Eref& e, const Qinfo* q, double val );
		double getMax( const Eref& e, const Qinfo* q ) const;
		...
		// DestFinfos
		//////////////////////////////////////////////////////////
		void setupAlpha( const Eref& e, const Qinfo* q,
			vector< double > parms );
		void setupTau( const Eref& e, const Qinfo* q,
			vector< double > parms );
		void tweakAlpha();
		void tweakTau();
		void setupGate( const Eref& e, const Qinfo* q,
			vector< double > parms );
