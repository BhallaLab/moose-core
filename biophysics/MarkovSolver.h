...
class MarkovSolver {
	...
	//Computes the updated state of the system.
	void computeState();	
	/////////////////////////
	//Scaling and squaring algorithm related functions.
	////////////////////////

	//Computes the m'th order Pade Approximant of the Q-matrix.
	Matrix* computePadeApproximant( Matrix*, unsigned int );

	//Computes the matrix exponential. Most of the really heavy lifting occurs
	//here.
	Matrix* computeMatrixExponential();
	
	double twoPower( unsigned int );
	///////////////////////////
	//MsgDest functions.
	//////////////////////////
	...
	void handleInstRates( Matrix );
	void setInitState( Vector );
