...
FOREACH(_CURRENT_VERSION ${_Python_VERSIONS})
  ...
  IF (PYTHON_EXECUTABLE)
    ...
    set(_PYTHON_PREFIX_HINT $ENV{HOME}/bin ${_PYTHON_BIN_DIR}/.. )
    set(_PYTHON_BIN_DIR)
  ...
  FIND_LIBRARY(PYTHON_LIBRARY
    NAMES
    python${_CURRENT_VERSION_NO_DOTS}_d
  ...
  IF (NOT ("${PYTHON_INCLUDE_DIR}" STREQUAL "${PYTHON_INCLUDE_DIR2}"))
	  ...
	  set(PYTHON_INCLUDE_DIR "${PYTHON_INCLUDE_DIR_TMP};${PYTHON_INCLUDE_DIR2}" CACHE PATH "Python include dir")
  ENDIF (NOT ("${PYTHON_INCLUDE_DIR}" STREQUAL "${PYTHON_INCLUDE_DIR2}"))
...
FUNCTION(PYTHON_ADD_MODULE _NAME )
  ...
  SET(ALL_C_PYTHON_MODULES "${_NAME};${ALL_C_PYTHON_MODULES}" CACHE STRING "" FORCE)
