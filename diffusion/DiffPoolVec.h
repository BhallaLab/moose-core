...
public:
    DiffPoolVec();
    void process();
    void reinit( const vector< double >& vols );
    void advance( double dt );
    double getConcInit( unsigned int vox ) const;
    void setConcInit( unsigned int vox, double value );
...
private:
    ...
    vector< double > concInit_; /// Boundary condition: Initial 'n'.
