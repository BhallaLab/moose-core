...
SrcFinfo1< double >* ZombieCompartment::VmOut()
{
    ...
    VmOut( "VmOut", "Sends out Vm value of compartment on each timestep" );
    return &VmOut;
}
...
void ZombieCompartment::setEm( const Eref& e , double Em )
{
    hsolve_->setEm( e.id(), Em );
}

double ZombieCompartment::getEm( const Eref& e  ) const
{
    return hsolve_->getEm( e.id() );
}

void ZombieCompartment::setCm( const Eref& e , double Cm )
{
    if ( rangeWarning( "Cm", Cm ) ) return;
    hsolve_->setCm( e.id(), Cm );
}

double ZombieCompartment::getCm( const Eref& e  ) const
{
    return hsolve_->getCm( e.id() );
}

void ZombieCompartment::setRm( const Eref& e , double Rm )
{
    if ( rangeWarning( "Rm", Rm ) ) return;
    hsolve_->setRm( e.id(), Rm );
}

double ZombieCompartment::getRm( const Eref& e  ) const
{
    return hsolve_->getRm( e.id() );
}

void ZombieCompartment::setRa( const Eref& e , double Ra )
{
    if ( rangeWarning( "Ra", Ra ) ) return;
    hsolve_->setRa( e.id(), Ra );
}

double ZombieCompartment::getRa( const Eref& e  ) const
{
...
double ZombieCompartment::getIm( const Eref& e  ) const
{
    return hsolve_->getIm( e.id() );
}

void ZombieCompartment::setInject( const Eref& e , double Inject )
{
    hsolve_->setInject( e.id(), Inject );
}

double ZombieCompartment::getInject( const Eref& e  ) const
{
    return hsolve_->getInject( e.id() );
}

void ZombieCompartment::setInitVm( const Eref& e , double initVm )
{
    hsolve_->setInitVm( e.id(), initVm );
}

double ZombieCompartment::getInitVm( const Eref& e  ) const
{
...
/*
void ZombieCompartment::setDiameter( const Eref& e , double value )
{
...
double ZombieCompartment::getDiameter( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setLength( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getLength( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setX0( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getX0( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setY0( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getY0( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setZ0( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getZ0( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setX( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getX( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setY( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getY( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::setZ( const Eref& e , double value )
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
double ZombieCompartment::getZ( const Eref& e  ) const
{
	Compartment* c = reinterpret_cast< Compartment* >(
		e.element()->dataHandler()->data( 0 ) );
...
void ZombieCompartment::handleChannel( const Eref& e , double Gk, double Ek )
{
...
void ZombieCompartment::injectMsg( const Eref& e , double current )
{
    hsolve_->addInject( e.id(), current );
}

void ZombieCompartment::randInject( const Eref& e , double prob, double current )
{
    //~ if ( mtrand() < prob * dt_ ) {
    //~ hsolve_->addInject( e.id(), current );
    //~ }
