...
void CplxEnzBase::setK1( const Eref& e, const Qinfo* q, double v )
{
	vSetK1( e, q, v );
}

double CplxEnzBase::getK1( const Eref& e, const Qinfo* q ) const
{
	return vGetK1( e, q );
}

void CplxEnzBase::setK2( const Eref& e, const Qinfo* q, double v )
{
	vSetK2( e, q, v );
}

double CplxEnzBase::getK2( const Eref& e, const Qinfo* q ) const
{
	return vGetK2( e, q );
}
...
void CplxEnzBase::setRatio( const Eref& e, const Qinfo* q, double v )
{
	vSetRatio( e, q, v );
}

double CplxEnzBase::getRatio( const Eref& e, const Qinfo* q ) const
{
	return vGetRatio( e, q );
}

void CplxEnzBase::setConcK1( const Eref& e, const Qinfo* q, double v )
{
	vSetConcK1( e, q, v );
}

double CplxEnzBase::getConcK1( const Eref& e, const Qinfo* q ) const
{
	return vGetConcK1( e, q );
}
