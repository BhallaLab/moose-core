...
class EnzBase
{
	public: 
		...
		//////////////////////////////////////////////////////////////////
		virtual void vSetKm( const Eref& e, const Qinfo* q, double v ) = 0;
		virtual double vGetKm( const Eref& e, const Qinfo* q ) const = 0;
		virtual void vSetNumKm( const Eref& e, const Qinfo* q, double v ) = 0;
		virtual double vGetNumKm( const Eref& e, const Qinfo* q ) const = 0;
		virtual void vSetKcat( const Eref& e, const Qinfo* q, double v ) = 0;
		virtual double vGetKcat( const Eref& e, const Qinfo* q ) const = 0;
