...
const std::string AscFile::className = "AscFile";
AscFile::AscFile(Id id):PyMooseBase(id){}
AscFile::AscFile(std::string path):PyMooseBase(className, path){}
AscFile::AscFile(std::string name, Id parentId):PyMooseBase(className, name, parentId){}
AscFile::AscFile(std::string name, PyMooseBase& parent):PyMooseBase(className, name, parent){}
...
AscFile::~AscFile(){}
const std::string& AscFile::getType(){ return className; }
