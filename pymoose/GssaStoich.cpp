...
const std::string GssaStoich::className = "GssaStoich";
GssaStoich::GssaStoich(Id id):PyMooseBase(id){}
GssaStoich::GssaStoich(std::string path):PyMooseBase(className, path){}
GssaStoich::GssaStoich(std::string name, Id parentId):PyMooseBase(className, name, parentId){}
GssaStoich::GssaStoich(std::string name, PyMooseBase& parent):PyMooseBase(className, name, parent){}
...
const std::string& GssaStoich::getType(){ return className; }
