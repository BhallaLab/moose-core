...
HHChannel2D::HHChannel2D(Id id):PyMooseBase(id){}
HHChannel2D::HHChannel2D(std::string path):PyMooseBase(className_, path){}
HHChannel2D::HHChannel2D(std::string name, Id parentId):PyMooseBase(className_, name, parentId){}
HHChannel2D::HHChannel2D(std::string name, PyMooseBase& parent):PyMooseBase(className_, name, parent){}
HHChannel2D::HHChannel2D(const HHChannel2D& src, std::string objectName, PyMooseBase& parent):PyMooseBase(src, objectName, parent){}
