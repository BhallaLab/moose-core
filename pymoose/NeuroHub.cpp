...
const std::string NeuroHub::className = "NeuroHub";
NeuroHub::NeuroHub(Id id):PyMooseBase(id){}
NeuroHub::NeuroHub(std::string path):PyMooseBase(className, path){}
NeuroHub::NeuroHub(std::string name, Id parentId):PyMooseBase(className, name, parentId){}
NeuroHub::NeuroHub(std::string name, PyMooseBase& parent):PyMooseBase(className, name, parent){}
...
NeuroHub::~NeuroHub(){}
const std::string& NeuroHub::getType(){ return className; }
#endif
