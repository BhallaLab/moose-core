...
const std::string NeuroScan::className = "NeuroScan";
NeuroScan::NeuroScan(Id id):PyMooseBase(id){}
NeuroScan::NeuroScan(std::string path):PyMooseBase(className, path){}
NeuroScan::NeuroScan(std::string name, Id parentId):PyMooseBase(className, name, parentId){}
NeuroScan::NeuroScan(std::string name, PyMooseBase& parent):PyMooseBase(className, name, parent){}
...
NeuroScan::~NeuroScan(){}
const std::string& NeuroScan::getType(){ return className; }
