...
{
    unsigned int nMols;
    get < unsigned int > (Element::element(id_), "nMols",nMols);
    return nMols;
}
void Stoich::__set_nMols( unsigned int nMols )
{
    set < unsigned int > (Element::element(id_), "nMols", nMols);
}
unsigned int Stoich::__get_nVarMols() const
{
    unsigned int nVarMols;
    get < unsigned int > (Element::element(id_), "nVarMols",nVarMols);
    return nVarMols;
}
void Stoich::__set_nVarMols( unsigned int nVarMols )
{
    set < unsigned int > (Element::element(id_), "nVarMols", nVarMols);
}
unsigned int Stoich::__get_nSumTot() const
{
    unsigned int nSumTot;
    get < unsigned int > (Element::element(id_), "nSumTot",nSumTot);
    return nSumTot;
}
void Stoich::__set_nSumTot( unsigned int nSumTot )
{
    set < unsigned int > (Element::element(id_), "nSumTot", nSumTot);
}
unsigned int Stoich::__get_nBuffered() const
{
    unsigned int nBuffered;
    get < unsigned int > (Element::element(id_), "nBuffered",nBuffered);
    return nBuffered;
}
void Stoich::__set_nBuffered( unsigned int nBuffered )
{
    set < unsigned int > (Element::element(id_), "nBuffered", nBuffered);
}
unsigned int Stoich::__get_nReacs() const
{
    unsigned int nReacs;
    get < unsigned int > (Element::element(id_), "nReacs",nReacs);
    return nReacs;
}
void Stoich::__set_nReacs( unsigned int nReacs )
{
    set < unsigned int > (Element::element(id_), "nReacs", nReacs);
}
...
{
    unsigned int nMMenz;
    get < unsigned int > (Element::element(id_), "nMMenz",nMMenz);
    return nMMenz;
}
void Stoich::__set_nMMenz( unsigned int nMMenz )
{
    set < unsigned int > (Element::element(id_), "nMMenz", nMMenz);
}
unsigned int Stoich::__get_nExternalRates() const
{
    unsigned int nExternalRates;
    get < unsigned int > (Element::element(id_), "nExternalRates",nExternalRates);
    return nExternalRates;
}
void Stoich::__set_nExternalRates( unsigned int nExternalRates )
{
    set < unsigned int > (Element::element(id_), "nExternalRates", nExternalRates);
}
bool Stoich::__get_useOneWayReacs() const
{
    bool useOneWayReacs;
    get < bool > (Element::element(id_), "useOneWayReacs",useOneWayReacs);
    return useOneWayReacs;
}
void Stoich::__set_useOneWayReacs( bool useOneWayReacs )
{
    set < bool > (Element::element(id_), "useOneWayReacs", useOneWayReacs);
}
...
unsigned int Stoich::__get_rateVectorSize() const
{
    ...
    get < unsigned int > (Element::element(id_), "rateVectorSize",rateVectorSize);
    return rateVectorSize;
}
void Stoich::__set_rateVectorSize( unsigned int rateVectorSize )
{
    set < unsigned int > (Element::element(id_), "rateVectorSize", rateVectorSize);
}
#endif
