...
#
# Created: Wed May 18 00:47:37 2011
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setTabOrder(self.vizMaxVal, self.acceptButton)
        Dialog.setTabOrder(self.acceptButton, self.resetButton)
        Dialog.setTabOrder(self.resetButton, self.vizCells)
        Dialog.setTabOrder(self.vizCells, self.closeButton)
        Dialog.setTabOrder(self.closeButton, self.addCellButton)
        Dialog.setTabOrder(self.addCellButton, self.removeCellButton)
        Dialog.setTabOrder(self.removeCellButton, self.allCellsButton)
        Dialog.setTabOrder(self.allCellsButton, self.styleComboBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.variable.setToolTip(QtGui.QApplication.translate("Dialog", "Name of the object relative to path", None, QtGui.QApplication.UnicodeUTF8))
        self.variable.setText(QtGui.QApplication.translate("Dialog", "Vm", None, QtGui.QApplication.UnicodeUTF8))
        self.moosepath.setToolTip(QtGui.QApplication.translate("Dialog", "Name of the moose path relative to compartment", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.variable_2.setToolTip(QtGui.QApplication.translate("Dialog", "Name of the object relative to path", None, QtGui.QApplication.UnicodeUTF8))
        self.moosepath_2.setToolTip(QtGui.QApplication.translate("Dialog", "Name of the moose path relative to compartment", None, QtGui.QApplication.UnicodeUTF8))
