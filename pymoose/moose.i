...
%include "GLview.h"
%attribute(pymoose::GLview, const std::string, vizpath, __get_vizpath, __set_vizpath)
%attribute(pymoose::GLview, const std::string, host, __get_clientHost, __set_clientHost)
%attribute(pymoose::GLview, const std::string, port, __get_clientPort, __set_clientPort)
%attribute(pymoose::GLview, const std::string, relpath, __get_relPath, __set_relPath)
%attribute(pymoose::GLview, const std::string, value1, __get_value1Field, __set_value1Field)
...
%attribute(pymoose::GLview, const std::string, value2, __get_value2Field, __set_value2Field)
...
%attribute(pymoose::GLview, const std::string, value3, __get_value3Field, __set_value3Field)
...
%attribute(pymoose::GLview, const std::string, value4, __get_value4Field, __set_value4Field)
...
%attribute(pymoose::GLview, const std::string, value5, __get_value5Field, __set_value5Field)
...
%attribute(pymoose::GLview, const std::string, bgcolor, __get_bgColor, __set_bgColor)
%attribute(pymoose::GLview, const std::string, sync, __get_syncMode, __set_syncMode)
%attribute(pymoose::GLview, const std::string, grid, __get_gridMode, __set_gridMode)
