...
class PyMooseContext(object):
    ...
    def readNeuroML(*args):
        """readNeuroML(self, string fileName, string modelPath)"""
        return _moose.PyMooseContext_readNeuroML(*args)
    ...
    def getValueFieldList(*args):
        """getValueFieldList(self, Id id) -> string_vector"""
        return _moose.PyMooseContext_getValueFieldList(*args)
...
class PyMooseBase(object):
    ...
    def addField(*args):
        ...
        return _moose.PyMooseBase_addField(*args)
...
class Interpol(PyMooseBase):
    ...
    def clear(*args):
        """clear(self)"""
        return _moose.Interpol_clear(*args)

    def push(*args):
        """push(self, double ?)"""
        return _moose.Interpol_push(*args)

    def pop(*args):
        """pop(self)"""
        return _moose.Interpol_pop(*args)
...
class SpikeGen(PyMooseBase):
    ...
    def __get_edgeTriggered(*args):
        """__get_edgeTriggered(self) -> int"""
        return _moose.SpikeGen___get_edgeTriggered(*args)

    def __set_edgeTriggered(*args):
        """__set_edgeTriggered(self, int edgeTriggered)"""
        return _moose.SpikeGen___set_edgeTriggered(*args)
...
class CaConc(PyMooseBase):
    ...
    def __get_ceiling(*args):
        """__get_ceiling(self) -> double"""
        return _moose.CaConc___get_ceiling(*args)

    def __set_ceiling(*args):
        """__set_ceiling(self, double ceiling)"""
        return _moose.CaConc___set_ceiling(*args)

    def __get_floor(*args):
        """__get_floor(self) -> double"""
        return _moose.CaConc___get_floor(*args)

    def __set_floor(*args):
        """__set_floor(self, double floor)"""
        return _moose.CaConc___set_floor(*args)
...
class Adaptor(PyMooseBase):
    ...
    def getType(*args):
        """getType(self) -> string"""
        return _moose.Adaptor_getType(*args)

    def __get_inputOffset(*args):
        """__get_inputOffset(self) -> double"""
        return _moose.Adaptor___get_inputOffset(*args)

    def __set_inputOffset(*args):
        """__set_inputOffset(self, double inputOffset)"""
        return _moose.Adaptor___set_inputOffset(*args)

    def __get_outputOffset(*args):
        """__get_outputOffset(self) -> double"""
        return _moose.Adaptor___get_outputOffset(*args)

    def __set_outputOffset(*args):
        """__set_outputOffset(self, double outputOffset)"""
        return _moose.Adaptor___set_outputOffset(*args)

    def __get_scale(*args):
        """__get_scale(self) -> double"""
        return _moose.Adaptor___get_scale(*args)

    def __set_scale(*args):
        """__set_scale(self, double scale)"""
        return _moose.Adaptor___set_scale(*args)

    def __get_output(*args):
        """__get_output(self) -> double"""
        return _moose.Adaptor___get_output(*args)
...
class SigNeur(PyMooseBase):
    ...
    def __get_cellMethod(*args):
        ...
        return _moose.SigNeur___get_cellMethod(*args)

    def __set_cellMethod(*args):
        """__set_cellMethod(self, string cellMethod)"""
        return _moose.SigNeur___set_cellMethod(*args)

    def __get_spineMethod(*args):
        """__get_spineMethod(self) -> string"""
        return _moose.SigNeur___get_spineMethod(*args)

    def __set_spineMethod(*args):
        """__set_spineMethod(self, string spineMethod)"""
        return _moose.SigNeur___set_spineMethod(*args)

    def __get_dendMethod(*args):
        """__get_dendMethod(self) -> string"""
        return _moose.SigNeur___get_dendMethod(*args)

    def __set_dendMethod(*args):
        """__set_dendMethod(self, string dendMethod)"""
        return _moose.SigNeur___set_dendMethod(*args)

    def __get_somaMethod(*args):
        """__get_somaMethod(self) -> string"""
        return _moose.SigNeur___get_somaMethod(*args)

    def __set_somaMethod(*args):
        """__set_somaMethod(self, string somaMethod)"""
        return _moose.SigNeur___set_somaMethod(*args)

    def __get_sigDt(*args):
        """__get_sigDt(self) -> double"""
        return _moose.SigNeur___get_sigDt(*args)

    def __set_sigDt(*args):
        """__set_sigDt(self, double sigDt)"""
        return _moose.SigNeur___set_sigDt(*args)

    def __get_cellDt(*args):
        """__get_cellDt(self) -> double"""
        return _moose.SigNeur___get_cellDt(*args)

    def __set_cellDt(*args):
        """__set_cellDt(self, double cellDt)"""
        return _moose.SigNeur___set_cellDt(*args)

    def __get_Dscale(*args):
        """__get_Dscale(self) -> double"""
        return _moose.SigNeur___get_Dscale(*args)

    def __set_Dscale(*args):
        """__set_Dscale(self, double Dscale)"""
        return _moose.SigNeur___set_Dscale(*args)

    def __get_lambda(*args):
        """__get_lambda(self) -> double"""
        return _moose.SigNeur___get_lambda(*args)

    def __set_lambda(*args):
        """__set_lambda(self, double lambda)"""
        return _moose.SigNeur___set_lambda(*args)

    def __get_parallelMode(*args):
        """__get_parallelMode(self) -> int"""
        return _moose.SigNeur___get_parallelMode(*args)

    def __set_parallelMode(*args):
        """__set_parallelMode(self, int parallelMode)"""
        return _moose.SigNeur___set_parallelMode(*args)

    def __get_updateStep(*args):
        """__get_updateStep(self) -> double"""
        return _moose.SigNeur___get_updateStep(*args)

    def __set_updateStep(*args):
        """__set_updateStep(self, double updateStep)"""
        return _moose.SigNeur___set_updateStep(*args)

    def __get_calciumScale(*args):
        """__get_calciumScale(self) -> double"""
        return _moose.SigNeur___get_calciumScale(*args)

    def __set_calciumScale(*args):
        """__set_calciumScale(self, double calciumScale)"""
        return _moose.SigNeur___set_calciumScale(*args)

    def __get_dendInclude(*args):
        """__get_dendInclude(self) -> string"""
        return _moose.SigNeur___get_dendInclude(*args)

    def __set_dendInclude(*args):
        """__set_dendInclude(self, string dendInclude)"""
        return _moose.SigNeur___set_dendInclude(*args)

    def __get_dendExclude(*args):
        """__get_dendExclude(self) -> string"""
        return _moose.SigNeur___get_dendExclude(*args)

    def __set_dendExclude(*args):
