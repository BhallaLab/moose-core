...
class SteadyState(PyMooseBase):
    """Proxy of C++ SteadyState class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
    ...
    def getType(*args):
        """getType(self) -> string"""
        return _moose.SteadyState_getType(*args)

    def __get_badStoichiometry(*args):
        """__get_badStoichiometry(self) -> bool"""
        return _moose.SteadyState___get_badStoichiometry(*args)

    def __get_isInitialized(*args):
        """__get_isInitialized(self) -> bool"""
        return _moose.SteadyState___get_isInitialized(*args)

    def __get_nIter(*args):
        """__get_nIter(self) -> unsigned int"""
        return _moose.SteadyState___get_nIter(*args)

    def __get_maxIter(*args):
        """__get_maxIter(self) -> unsigned int"""
        return _moose.SteadyState___get_maxIter(*args)

    def __set_maxIter(*args):
        """__set_maxIter(self, unsigned int maxIter)"""
        return _moose.SteadyState___set_maxIter(*args)

    def __get_convergenceCriterion(*args):
        """__get_convergenceCriterion(self) -> double"""
        return _moose.SteadyState___get_convergenceCriterion(*args)

    def __set_convergenceCriterion(*args):
        """__set_convergenceCriterion(self, double convergenceCriterion)"""
        return _moose.SteadyState___set_convergenceCriterion(*args)

    def __get_rank(*args):
        """__get_rank(self) -> unsigned int"""
        return _moose.SteadyState___get_rank(*args)
...
SteadyState.className_ = _moose.cvar.SteadyState_className_
...
class InterSolverFlux(PyMooseBase):
    """Proxy of C++ InterSolverFlux class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(self, Id id) -> InterSolverFlux
        __init__(self, string path) -> InterSolverFlux
        __init__(self, string name, Id parentId) -> InterSolverFlux
        __init__(self, string name, PyMooseBase parent) -> InterSolverFlux
        __init__(self, InterSolverFlux src, string name, PyMooseBase parent) -> InterSolverFlux
        __init__(self, InterSolverFlux src, string name, Id parent) -> InterSolverFlux
        __init__(self, InterSolverFlux src, string path) -> InterSolverFlux
        __init__(self, Id src, string name, Id parent) -> InterSolverFlux
        """
        this = _moose.new_InterSolverFlux(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _moose.delete_InterSolverFlux
    __del__ = lambda self : None;
    def getType(*args):
        """getType(self) -> string"""
        return _moose.InterSolverFlux_getType(*args)

    def __get_method(*args):
        """__get_method(self) -> string"""
        return _moose.InterSolverFlux___get_method(*args)

    def __set_method(*args):
        """__set_method(self, string method)"""
        return _moose.InterSolverFlux___set_method(*args)

    method = _swig_property(_moose.InterSolverFlux_method_get, _moose.InterSolverFlux_method_set)
InterSolverFlux_swigregister = _moose.InterSolverFlux_swigregister
InterSolverFlux_swigregister(InterSolverFlux)
InterSolverFlux.className_ = _moose.cvar.InterSolverFlux_className_
