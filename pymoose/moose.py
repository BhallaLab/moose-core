...
class PyMooseBase(object):
    ...
    id = _swig_property(_moose.PyMooseBase_id_get, _moose.PyMooseBase_id_set)
    parent = _swig_property(_moose.PyMooseBase_parent_get, _moose.PyMooseBase_parent_set)
...
class Class(PyMooseBase):
    ...
    name = _swig_property(_moose.Class_name_get, _moose.Class_name_set)
    author = _swig_property(_moose.Class_author_get, _moose.Class_author_set)
    description = _swig_property(_moose.Class_description_get, _moose.Class_description_set)
...
class SynChan(PyMooseBase):
    ...
    numSynapses = _swig_property(_moose.SynChan_numSynapses_get, _moose.SynChan_numSynapses_set)
...
class BinSynchan(PyMooseBase):
    ...
    numSynapses = _swig_property(_moose.BinSynchan_numSynapses_get, _moose.BinSynchan_numSynapses_set)
...
class StochSynchan(PyMooseBase):
    ...
    numSynapses = _swig_property(_moose.StochSynchan_numSynapses_get, _moose.StochSynchan_numSynapses_set)
...
class RandomSpike(PyMooseBase):
    ...
    lastEvent = _swig_property(_moose.RandomSpike_lastEvent_get, _moose.RandomSpike_lastEvent_set)
...
class PulseGen(PyMooseBase):
    ...
    output = _swig_property(_moose.PulseGen_output_get, _moose.PulseGen_output_set)
    ...
    prevInput = _swig_property(_moose.PulseGen_prevInput_get, _moose.PulseGen_prevInput_set)
...
class HHGate(PyMooseBase):
    ...
    A = _swig_property(_moose.HHGate_A_get, _moose.HHGate_A_set)
    B = _swig_property(_moose.HHGate_B_get, _moose.HHGate_B_set)
...
class KineticManager(PyMooseBase):
    ...
    variableDt = _swig_property(_moose.KineticManager_variableDt_get, _moose.KineticManager_variableDt_set)
    singleParticle = _swig_property(_moose.KineticManager_singleParticle_get, _moose.KineticManager_singleParticle_set)
    multiscale = _swig_property(_moose.KineticManager_multiscale_get, _moose.KineticManager_multiscale_set)
    implicit = _swig_property(_moose.KineticManager_implicit_get, _moose.KineticManager_implicit_set)
    description = _swig_property(_moose.KineticManager_description_get, _moose.KineticManager_description_set)
    recommendedDt = _swig_property(_moose.KineticManager_recommendedDt_get, _moose.KineticManager_recommendedDt_set)
...
class Panel(PyMooseBase):
    ...
    nPts = _swig_property(_moose.Panel_nPts_get, _moose.Panel_nPts_set)
    nDims = _swig_property(_moose.Panel_nDims_get, _moose.Panel_nDims_set)
    nNeighbors = _swig_property(_moose.Panel_nNeighbors_get, _moose.Panel_nNeighbors_set)
    shapeId = _swig_property(_moose.Panel_shapeId_get, _moose.Panel_shapeId_set)
...
class Surface(PyMooseBase):
    ...
    volume = _swig_property(_moose.Surface_volume_get, _moose.Surface_volume_set)
