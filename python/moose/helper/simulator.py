...
class Simulator:
    ...
    def __init__(self, arg):
        ...
        if not _moose.exists(self.elecPath):
            utils.dump("USER", 
            ...
            raise UserWarning("Missing _moose path {}".format(self.elecPath))
    ...
    def updateMoose(self, populationDict, projectionDict):
        """Update the _moose, as per the simulation specific settings.
        """
    ...
    def setupRecord(self, xmlElem):
        ...
        if elemType == 'soma':
            # Now get all records and setup _moose for them.
    ...
    def setupSomaRecord(self, recordXml, params):
        ...
        _moose.useClock(self.tableClockId, self.tablePath+'/##', 'process')
    ...
    def simulateNetwork(self):
        ...
        try:
            _moose.utils.resetSim([self.elecPath, self.cellPath]
                    , self.simDt
                    , self.plotDt
    ...
    def configure2DPlot(self, plotXml):
        ...
        _moose.setClock(self.tableClockId, self.step)
