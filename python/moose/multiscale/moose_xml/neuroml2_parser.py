...
#
# Generated Sun Sep  8 00:05:06 2013 by generateDS.py version 2.11a.
#
...
class MembraneProperties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, channelPopulation=None, channelDensity=None, channelDensityNernst=None, spikeThresh=None, specificCapacitance=None, initMembPotential=None, reversalPotential=None):
    ...
    def get_channelDensityNernst(self): return self.channelDensityNernst
    def set_channelDensityNernst(self, channelDensityNernst): self.channelDensityNernst = channelDensityNernst
    def add_channelDensityNernst(self, value): self.channelDensityNernst.append(value)
    def insert_channelDensityNernst(self, index, value): self.channelDensityNernst[index] = value
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('channelDensityNernst=[\n')
        level += 1
        for channelDensityNernst_ in self.channelDensityNernst:
            showIndent(outfile, level)
...
class Connection(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, preFractionAlong=None, preCellId=None, postFractionAlong=None, postSegmentId=None, postCellId=None, preSegmentId=None, id=None):
        self.preFractionAlong = _cast(None, preFractionAlong)
        self.preCellId = _cast(None, preCellId)
        self.postFractionAlong = _cast(None, postFractionAlong)
        self.postSegmentId = _cast(None, postSegmentId)
        self.postCellId = _cast(None, postCellId)
        self.preSegmentId = _cast(None, preSegmentId)
        self.id = _cast(int, id)
        pass
    def factory(*args_, **kwargs_):
    ...
    factory = staticmethod(factory)
    def get_preFractionAlong(self): return self.preFractionAlong
    def set_preFractionAlong(self, preFractionAlong): self.preFractionAlong = preFractionAlong
    def get_preCellId(self): return self.preCellId
    def set_preCellId(self, preCellId): self.preCellId = preCellId
    def get_postFractionAlong(self): return self.postFractionAlong
    def set_postFractionAlong(self, postFractionAlong): self.postFractionAlong = postFractionAlong
    def get_postSegmentId(self): return self.postSegmentId
    def set_postSegmentId(self, postSegmentId): self.postSegmentId = postSegmentId
    def get_postCellId(self): return self.postCellId
    def set_postCellId(self, postCellId): self.postCellId = postCellId
    def get_preSegmentId(self): return self.preSegmentId
    def set_preSegmentId(self, preSegmentId): self.preSegmentId = preSegmentId
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def validate_ZeroToOne(self, value):
        # Validate type ZeroToOne, a restriction on xs:double.
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Connection'):
        if self.preFractionAlong is not None and 'preFractionAlong' not in already_processed:
            already_processed.add('preFractionAlong')
            outfile.write(' preFractionAlong=%s' % (quote_attrib(self.preFractionAlong), ))
        ...
        if self.postFractionAlong is not None and 'postFractionAlong' not in already_processed:
            already_processed.add('postFractionAlong')
            outfile.write(' postFractionAlong=%s' % (quote_attrib(self.postFractionAlong), ))
        if self.postSegmentId is not None and 'postSegmentId' not in already_processed:
            already_processed.add('postSegmentId')
            outfile.write(' postSegmentId=%s' % (quote_attrib(self.postSegmentId), ))
        ...
        if self.preSegmentId is not None and 'preSegmentId' not in already_processed:
            already_processed.add('preSegmentId')
            outfile.write(' preSegmentId=%s' % (quote_attrib(self.preSegmentId), ))
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id="%s"' % self.gds_format_integer(self.id, input_name='id'))
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.preFractionAlong is not None and 'preFractionAlong' not in already_processed:
            already_processed.add('preFractionAlong')
            showIndent(outfile, level)
            outfile.write('preFractionAlong=%e,\n' % (self.preFractionAlong,))
        if self.preCellId is not None and 'preCellId' not in already_processed:
            already_processed.add('preCellId')
            showIndent(outfile, level)
        ...
        if self.postFractionAlong is not None and 'postFractionAlong' not in already_processed:
            already_processed.add('postFractionAlong')
            showIndent(outfile, level)
            outfile.write('postFractionAlong=%e,\n' % (self.postFractionAlong,))
        if self.postSegmentId is not None and 'postSegmentId' not in already_processed:
            already_processed.add('postSegmentId')
            showIndent(outfile, level)
            outfile.write('postSegmentId=%d,\n' % (self.postSegmentId,))
        if self.postCellId is not None and 'postCellId' not in already_processed:
            already_processed.add('postCellId')
            showIndent(outfile, level)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'preFractionAlong' not in already_processed:
            already_processed.add('preFractionAlong')
            try:
                self.preFractionAlong = float(value)
            except ValueError, exp:
        ...
        if value is not None and 'postFractionAlong' not in already_processed:
            already_processed.add('postFractionAlong')
            try:
                self.postFractionAlong = float(value)
            except ValueError, exp:
        ...
        if value is not None and 'postSegmentId' not in already_processed:
            already_processed.add('postSegmentId')
            try:
                self.postSegmentId = int(value)
            except ValueError, exp:
                raise_parse_error(node, 'Bad integer attribute: %s' % exp)
            if self.postSegmentId < 0:
                raise_parse_error(node, 'Invalid NonNegativeInteger')
            self.validate_SegmentId(self.postSegmentId)    # validate type SegmentId
        ...
        if value is not None and 'preSegmentId' not in already_processed:
            already_processed.add('preSegmentId')
            try:
                self.preSegmentId = int(value)
            except ValueError, exp:
                raise_parse_error(node, 'Bad integer attribute: %s' % exp)
            if self.preSegmentId < 0:
                raise_parse_error(node, 'Invalid NonNegativeInteger')
            self.validate_SegmentId(self.preSegmentId)    # validate type SegmentId
        value = find_attr_value_('id', node)
        if value is not None and 'id' not in already_processed:
            already_processed.add('id')
            try:
...
class BaseWithoutId(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, neuroLexId=None, extensiontype_=None):
...
class Base(BaseWithoutId):
    ...
    def __init__(self, neuroLexId=None, id=None, extensiontype_=None):
        super(Base, self).__init__(neuroLexId, extensiontype_, )
        self.id = _cast(None, id)
        self.extensiontype_ = extensiontype_
    def factory(*args_, **kwargs_):
        if Base.subclass:
...
class Standalone(Base):
    ...
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, extensiontype_=None):
        super(Standalone, self).__init__(neuroLexId, id, extensiontype_, )
...
class SpikeSourcePoisson(Standalone):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, duration=None, start=None, rate=None):
        super(SpikeSourcePoisson, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class InputList(Base):
    ...
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, component=None, population=None, input=None):
...
class Projection(Base):
    ...
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, postsynapticPopulation=None, presynapticPopulation=None, synapse=None, connection=None):
...
class CellSet(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, select=None, anytypeobjs_=None):
        super(CellSet, self).__init__(neuroLexId, id, )
...
class Population(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, extracellularProperties=None, network=None, component=None, cell=None, type_=None, size=None, layout=None, instance=None):
        super(Population, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class Region(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, space=None, anytypeobjs_=None):
        super(Region, self).__init__(neuroLexId, id, )
        self.space = _cast(None, space)
        if anytypeobjs_ is None:
            self.anytypeobjs_ = []
        else:
...
class Space(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, basedOn=None, structure=None):
        super(Space, self).__init__(neuroLexId, id, )
...
class Network(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, type_=None, temperature=None, space=None, region=None, extracellularProperties=None, population=None, cellSet=None, synapticConnection=None, projection=None, explicitInput=None, inputList=None):
        super(Network, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        self.type_ = _cast(None, type_)
...
class SpikeGeneratorPoisson(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, averageRate=None):
        super(SpikeGeneratorPoisson, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class SpikeGeneratorRandom(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, minISI=None, maxISI=None):
        super(SpikeGeneratorRandom, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class SpikeGenerator(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, period=None):
        super(SpikeGenerator, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class SpikeArray(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, spike=None):
        super(SpikeArray, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        if spike is None:
            self.spike = []
        else:
            self.spike = spike
...
class Spike(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, time=None):
        super(Spike, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class VoltageClamp(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, delay=None, duration=None, seriesResistance=None, targetVoltage=None):
        super(VoltageClamp, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class RampGenerator(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, delay=None, duration=None, baselineAmplitude=None, startAmplitude=None, finishAmplitude=None):
        super(RampGenerator, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        self.delay = _cast(None, delay)
        self.duration = _cast(None, duration)
...
class SineGenerator(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, delay=None, phase=None, duration=None, period=None, amplitude=None):
        super(SineGenerator, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        self.delay = _cast(None, delay)
...
class PulseGenerator(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, delay=None, duration=None, amplitude=None):
        super(PulseGenerator, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        self.delay = _cast(None, delay)
        self.duration = _cast(None, duration)
        self.amplitude = _cast(None, amplitude)
        pass
...
class ReactionScheme(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, source=None, type_=None, anytypeobjs_=None):
        super(ReactionScheme, self).__init__(neuroLexId, id, )
...
class ExtracellularProperties(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, species=None):
        super(ExtracellularProperties, self).__init__(neuroLexId, id, )
        if species is None:
            self.species = []
        else:
            self.species = species
...
class ChannelDensityNernst(Base):
    ...
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, ionChannel=None, condDensity=None, segmentGroup='all', segment=None, ion=None):
        super(ChannelDensityNernst, self).__init__(neuroLexId, id, )
...
class ChannelDensity(Base):
    ...
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, segmentGroup='all', ion=None, ionChannel=None, erev=None, condDensity=None, segment=None, variableParameter=None):
...
class ChannelPopulation(Base):
    ...
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, segmentGroup='all', ion=None, number=None, ionChannel=None, erev=None, segment=None, variableParameter=None):
        super(ChannelPopulation, self).__init__(neuroLexId, id, )
        self.segmentGroup = _cast(None, segmentGroup)
        self.ion = _cast(None, ion)
        self.number = _cast(int, number)
        self.ionChannel = _cast(None, ionChannel)
...
class BiophysicalProperties(Standalone):
    ...
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, membraneProperties=None, intracellularProperties=None, extracellularProperties=None):
        super(BiophysicalProperties, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class InhomogeneousParam(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, variable=None, metric=None, proximal=None, distal=None):
        super(InhomogeneousParam, self).__init__(neuroLexId, id, )
...
class SegmentGroup(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, member=None, include=None, path=None, subTree=None, inhomogeneousParam=None):
        super(SegmentGroup, self).__init__(neuroLexId, id, )
        if member is None:
            self.member = []
        else:
            self.member = member
...
class Segment(BaseWithoutId):
    subclass = None
    superclass = BaseWithoutId
    def __init__(self, neuroLexId=None, id=None, name=None, parent=None, proximal=None, distal=None):
        super(Segment, self).__init__(neuroLexId, )
        self.id = _cast(None, id)
        self.name = _cast(None, name)
        self.parent = parent
        self.proximal = proximal
...
class Morphology(Standalone):
    ...
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, segment=None, segmentGroup=None):
        super(Morphology, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        if segment is None:
            self.segment = []
        else:
...
class BaseCell(Standalone):
    ...
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, extensiontype_=None):
        super(BaseCell, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
        self.extensiontype_ = extensiontype_
    def factory(*args_, **kwargs_):
...
class BaseSynapse(Standalone):
    ...
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, extensiontype_=None):
        super(BaseSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
        self.extensiontype_ = extensiontype_
    def factory(*args_, **kwargs_):
...
class DecayingPoolConcentrationModel(Standalone):
    ...
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, ion=None, shellThickness=None, restingConc=None, decayConstant=None, extensiontype_=None):
        super(DecayingPoolConcentrationModel, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
        self.ion = _cast(None, ion)
...
class GateHHRatesInf(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, instances=1, type_=None, notes=None, q10Settings=None, forwardRate=None, reverseRate=None, steadyState=None):
        super(GateHHRatesInf, self).__init__(neuroLexId, id, )
...
class GateHHRatesTau(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, instances=1, type_=None, notes=None, q10Settings=None, forwardRate=None, reverseRate=None, timeCourse=None):
        super(GateHHRatesTau, self).__init__(neuroLexId, id, )
        self.instances = _cast(int, instances)
        self.type_ = _cast(None, type_)
        self.notes = notes
        self.q10Settings = q10Settings
...
class GateHHTauInf(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, instances=1, type_=None, notes=None, q10Settings=None, timeCourse=None, steadyState=None):
        super(GateHHTauInf, self).__init__(neuroLexId, id, )
        self.instances = _cast(int, instances)
        self.type_ = _cast(None, type_)
        self.notes = notes
        self.q10Settings = q10Settings
...
class GateHHRates(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, instances=1, type_=None, notes=None, q10Settings=None, forwardRate=None, reverseRate=None):
        super(GateHHRates, self).__init__(neuroLexId, id, )
        self.instances = _cast(int, instances)
        self.type_ = _cast(None, type_)
        self.notes = notes
        self.q10Settings = q10Settings
...
class GateHHUndetermined(Base):
    subclass = None
    superclass = Base
    def __init__(self, neuroLexId=None, id=None, instances=1, type_=None, notes=None, q10Settings=None, forwardRate=None, reverseRate=None, timeCourse=None, steadyState=None):
        super(GateHHUndetermined, self).__init__(neuroLexId, id, )
        self.instances = _cast(int, instances)
        self.type_ = _cast(None, type_)
        self.notes = notes
        self.q10Settings = q10Settings
...
class IonChannel(Standalone):
    subclass = None
    superclass = Standalone
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, conductance=None, type_=None, species=None, gate=None, gateHHrates=None, gateHHratesTau=None, gateHHtauInf=None, gateHHratesInf=None):
        super(IonChannel, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class BasePynnSynapse(BaseSynapse):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn=None, extensiontype_=None):
        super(BasePynnSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
...
class basePyNNCell(BaseCell):
    subclass = None
    superclass = BaseCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, extensiontype_=None):
        super(basePyNNCell, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
...
class ConcentrationModel_D(DecayingPoolConcentrationModel):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, ion=None, shellThickness=None, restingConc=None, decayConstant=None, type_=None):
        super(ConcentrationModel_D, self).__init__(neuroLexId, id, metaid, notes, annotation, ion, shellThickness, restingConc, decayConstant, )
        self.type_ = _cast(None, type_)
        pass
    def factory(*args_, **kwargs_):
...
class Cell(BaseCell):
    ...
    subclass = None
    superclass = BaseCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, biophysicalProperties_attr=None, morphology_attr=None, morphology=None, biophysicalProperties=None):
        super(Cell, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class AdExIaFCell(BaseCell):
    subclass = None
    superclass = BaseCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, reset=None, EL=None, C=None, b=None, refract=None, VT=None, delT=None, a=None, thresh=None, gL=None, tauw=None):
        super(AdExIaFCell, self).__init__(neuroLexId, id, metaid, notes, annotation, )
...
class IzhikevichCell(BaseCell):
    subclass = None
    superclass = BaseCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, a=None, c=None, b=None, d=None, v0=None, thresh=None):
        super(IzhikevichCell, self).__init__(neuroLexId, id, metaid, notes, annotation, )
        self.a = _cast(None, a)
        self.c = _cast(None, c)
        self.b = _cast(None, b)
        self.d = _cast(None, d)
...
class IaFCell(BaseCell):
    subclass = None
    superclass = BaseCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, reset=None, C=None, thresh=None, leakConductance=None, leakReversal=None, extensiontype_=None):
        super(IaFCell, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
        self.reset = _cast(None, reset)
        self.C = _cast(None, C)
        self.thresh = _cast(None, thresh)
...
class IaFTauCell(BaseCell):
    subclass = None
    superclass = BaseCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, reset=None, tau=None, thresh=None, leakReversal=None, extensiontype_=None):
        super(IaFTauCell, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
        self.reset = _cast(None, reset)
        self.tau = _cast(None, tau)
        self.thresh = _cast(None, thresh)
        self.leakReversal = _cast(None, leakReversal)
...
class BaseConductanceBasedSynapse(BaseSynapse):
    subclass = None
    superclass = BaseSynapse
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, extensiontype_=None):
        super(BaseConductanceBasedSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, extensiontype_, )
        self.erev = _cast(None, erev)
...
class AlphaCurrSynapse(BasePynnSynapse):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn=None):
        super(AlphaCurrSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn, )
        pass
    def factory(*args_, **kwargs_):
...
class ExpCurrSynapse(BasePynnSynapse):
    ...
    superclass = BasePynnSynapse
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn=None):
        super(ExpCurrSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn, )
        pass
    def factory(*args_, **kwargs_):
...
class AlphaCondSynapse(BasePynnSynapse):
    subclass = None
    superclass = BasePynnSynapse
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn=None, e_rev=None):
        super(AlphaCondSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn, )
...
class ExpCondSynapse(BasePynnSynapse):
    ...
    superclass = BasePynnSynapse
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn=None, e_rev=None):
        super(ExpCondSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn, )
        self.e_rev = _cast(float, e_rev)
        pass
    def factory(*args_, **kwargs_):
...
class HH_cond_exp(basePyNNCell):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, gbar_K=None, e_rev_E=None, g_leak=None, e_rev_Na=None, e_rev_I=None, e_rev_K=None, e_rev_leak=None, v_offset=None, gbar_Na=None):
        super(HH_cond_exp, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, )
...
class basePyNNIaFCell(basePyNNCell):
    subclass = None
    superclass = basePyNNCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None, extensiontype_=None):
        super(basePyNNIaFCell, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, extensiontype_, )
...
class IaFRefCell(IaFCell):
    subclass = None
    superclass = IaFCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, reset=None, C=None, thresh=None, leakConductance=None, leakReversal=None, refract=None):
        super(IaFRefCell, self).__init__(neuroLexId, id, metaid, notes, annotation, reset, C, thresh, leakConductance, leakReversal, )
        self.refract = _cast(None, refract)
        pass
    def factory(*args_, **kwargs_):
...
class IaFTauRefCell(IaFTauCell):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, reset=None, tau=None, thresh=None, leakReversal=None, refract=None):
        super(IaFTauRefCell, self).__init__(neuroLexId, id, metaid, notes, annotation, reset, tau, thresh, leakReversal, )
        self.refract = _cast(None, refract)
        pass
    def factory(*args_, **kwargs_):
...
class ExpTwoSynapse(BaseConductanceBasedSynapse):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tauDecay=None, tauRise=None, extensiontype_=None):
        super(ExpTwoSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, erev, gbase, extensiontype_, )
...
class ExpOneSynapse(BaseConductanceBasedSynapse):
    subclass = None
    superclass = BaseConductanceBasedSynapse
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tauDecay=None):
        super(ExpOneSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, erev, gbase, )
        self.tauDecay = _cast(None, tauDecay)
        pass
    def factory(*args_, **kwargs_):
...
class IF_curr_exp(basePyNNIaFCell):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None):
        super(IF_curr_exp, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, )
        pass
    def factory(*args_, **kwargs_):
...
class IF_curr_alpha(basePyNNIaFCell):
    ...
    superclass = basePyNNIaFCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None):
        super(IF_curr_alpha, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, )
        pass
    def factory(*args_, **kwargs_):
...
class basePyNNIaFCondCell(basePyNNIaFCell):
    subclass = None
    superclass = basePyNNIaFCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None, e_rev_I=None, e_rev_E=None, extensiontype_=None):
        super(basePyNNIaFCondCell, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, extensiontype_, )
        self.e_rev_I = _cast(float, e_rev_I)
        self.e_rev_E = _cast(float, e_rev_E)
        self.extensiontype_ = extensiontype_
    def factory(*args_, **kwargs_):
...
class BlockingPlasticSynapse(ExpTwoSynapse):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, erev=None, gbase=None, tauDecay=None, tauRise=None, plasticityMechanism=None, blockMechanism=None):
        super(BlockingPlasticSynapse, self).__init__(neuroLexId, id, metaid, notes, annotation, erev, gbase, tauDecay, tauRise, )
...
class EIF_cond_alpha_isfa_ista(basePyNNIaFCondCell):
    ...
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None, e_rev_I=None, e_rev_E=None, a=None, delta_T=None, b=None, v_spike=None, tau_w=None):
        super(EIF_cond_alpha_isfa_ista, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, e_rev_I, e_rev_E, )
...
class EIF_cond_exp_isfa_ista(basePyNNIaFCondCell):
    ...
    superclass = basePyNNIaFCondCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None, e_rev_I=None, e_rev_E=None, a=None, delta_T=None, b=None, v_spike=None, tau_w=None):
        super(EIF_cond_exp_isfa_ista, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, e_rev_I, e_rev_E, )
        self.a = _cast(float, a)
        self.delta_T = _cast(float, delta_T)
        self.b = _cast(float, b)
        self.v_spike = _cast(float, v_spike)
...
class IF_cond_exp(basePyNNIaFCondCell):
    subclass = None
    superclass = basePyNNIaFCondCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None, e_rev_I=None, e_rev_E=None):
        super(IF_cond_exp, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, e_rev_I, e_rev_E, )
        pass
    def factory(*args_, **kwargs_):
...
class IF_cond_alpha(basePyNNIaFCondCell):
    ...
    superclass = basePyNNIaFCondCell
    def __init__(self, neuroLexId=None, id=None, metaid=None, notes=None, annotation=None, tau_syn_I=None, tau_syn_E=None, i_offset=None, cm=None, v_init=None, tau_refrac=None, v_thresh=None, tau_m=None, v_reset=None, v_rest=None, e_rev_I=None, e_rev_E=None):
        super(IF_cond_alpha, self).__init__(neuroLexId, id, metaid, notes, annotation, tau_syn_I, tau_syn_E, i_offset, cm, v_init, tau_refrac, v_thresh, tau_m, v_reset, v_rest, e_rev_I, e_rev_E, )
        pass
    def factory(*args_, **kwargs_):
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from nueroml2 import *\n\n')
        sys.stdout.write('import nueroml2 as model_\n\n')
