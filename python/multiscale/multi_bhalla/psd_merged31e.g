...
// Saved on Fri Oct 18 21:29:22 2013
...
"Dephosph is mainly by PP2B"
simundump kpool /kinetics/PSD/PP1_PSD/CaN 0 1e-11 1 1 6 6 0 0 6 0 \
...
""
simundump kpool /kinetics/PSD/CaM/CaM 1 1e-11 20 20 120 120 0 0 6 0 \
...
"Use K3 = 21.5 uM here from Stemmer and Klee table 3." \
"kb/kf =21.5 * 6e5 so kf = 7.75e-7, kb = 10"
simundump kpool /kinetics/PSD/CaM/CaM-Ca3 1 1e-11 0 0 0 0 0 0 6 0 \
...
""
simundump kpool /kinetics/PSD/CaM/CaM-Ca2 1 1e-11 0 0 0 0 0 0 6 0 \
...
"kf = 1.125e-4, kb = 8.4853" \
""
simundump kpool /kinetics/PSD/CaM/CaM-Ca 1 1e-11 0 0 0 0 0 0 6 0 \
...
"This is the intermediate where the TR2 end (the high-affinity end) has" \
"bound the Ca but the TR1 end has not."
simundump kpool /kinetics/PSD/CaM/Ca 1 1e-10 0.08 0.08 0.48 0.48 0 0 6 0 \
  /kinetics/geometry red blue 43 33 0
simundump text /kinetics/PSD/CaM/Ca/notes 0 ""
call /kinetics/PSD/CaM/Ca/notes LOAD \
""
simundump kpool /kinetics/PSD/CaM/CaM-Ca4 1 1e-11 0 0 0 0 0 0 6 0 \
...
""
simundump kpool /kinetics/PSD/CaM_CaN 1 1e-11 0 0 0 0 0 0 6 0 \
...
""
simundump kpool /kinetics/SPINE/CaM/CaM 1 1e-11 20 20 1080 1080 0 0 54 0 \
...
"Use K3 = 21.5 uM here from Stemmer and Klee table 3." \
"kb/kf =21.5 * 6e5 so kf = 7.75e-7, kb = 10"
simundump kpool /kinetics/SPINE/CaM/CaM-Ca3 1 1e-11 0 0 0 0 0 0 54 0 \
...
"kf = 1.125e-4, kb = 8.4853" \
""
simundump kpool /kinetics/SPINE/CaM/CaM-Ca2 1 1e-11 0 0 0 0 0 0 54 0 \
...
"kf = 1.125e-4, kb = 8.4853" \
""
simundump kpool /kinetics/SPINE/CaM/CaM-Ca 1 1e-11 0 0 0 0 0 0 54 0 \
...
"This is the intermediate where the TR2 end (the high-affinity end) has" \
"bound the Ca but the TR1 end has not."
simundump kpool /kinetics/SPINE/CaM/Ca 1 1e-10 0.08 0.08 4.32 4.32 0 0 54 0 \
  /kinetics/geometry red blue 45 -2 0
simundump text /kinetics/SPINE/CaM/Ca/notes 0 ""
call /kinetics/SPINE/CaM/Ca/notes LOAD \
""
simundump kpool /kinetics/SPINE/CaM/CaM-Ca4 1 1e-11 0 0 0 0 0 0 54 0 \
...
""
simundump kpool /kinetics/SPINE/CaM_CaN 1 1e-11 0 0 0 0 0 0 54 0 \
...
""
simundump kpool /kinetics/SPINE/CaN_BULK/CaN 0 1e-11 1 1 54 54 0 0 54 0 \
...
"18 Oct 2013: psd_merged31e.g: All DiffConsts 10x higher." \
""
