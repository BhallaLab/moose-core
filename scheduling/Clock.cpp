...
void Clock::handleStep( const Eref& e, unsigned long numSteps )
{
	...
	if ( isRunning_ || doingReinit_ ) {
        ...
        //progressFile.open( "__moose_progress__");
        //progressFile << "# This file is generated by MOOSE simulator" << endl;
        //progressFile << "# It logs the finished simulation time/total simulation time" << endl;
        time_t rawtime;
        struct tm * timeinfo;
        char now[80];
#endif
