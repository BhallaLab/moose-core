...
public:
	...
	/** 
	 * Called before object is destroyed, to set its affairs in order.
     ...
     */
    void blockNodeBalance(const Eref& e, unsigned int, unsigned int,
                          unsigned int);
     ...
     * and to carry out node balancing of data as per args.
     */
    void generalNodeBalance(const Eref& e, unsigned int myNode,
