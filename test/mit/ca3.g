...
float tmax = 1               // simulation time in sec
...
addmsg /cell/soma/Ca_conc /data/voltage PLOT Ca *conc *blue
addmsg /cell/soma/K_C /data/voltage PLOT Gk *gk *yellow
*/
