...
addtask Simulate /target/##[CLASS=gate] -action PROCESS

addtask Simulate /axon/##[CLASS=spiking] -action PROCESS
addtask Simulate /axon/##[CLASS=segment][CLASS!=membrane][CLASS!=gate]  \
    -action PROCESS

addtask Simulate /target/##[CLASS=segment][CLASS!=membrane][CLASS!=gate]  \
    -action PROCESS
