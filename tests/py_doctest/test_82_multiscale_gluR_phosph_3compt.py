...
def test():
    ...
    Rdesigneur: Elec model has 3 compartments and 2 spines on 3 compartments.
        Chem part of model has the following compartments: 
        | In dend, 56 voxels X 1 pools
        | In spine, 2 voxels X 5 pools
        | In psd, 2 voxels X 5 pools
    array([3.522e-05, 3.298e-04, 1.752e-05, 1.879e-02, 1.629e-02, 1.533e-04,
